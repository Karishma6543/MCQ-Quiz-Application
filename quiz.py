...
def easy():
    ...
    easyQ = [
                 ...
                 [
                    "Which one among the following radiation carries maximum energy?" ,
                    "Ultraviolet rays",
                    "Gamma rays",
                    "X-rays",
                    "Infra-red rays"
                ...
                [
                    "The metal whose salts are sensitive to light is __________" ,
                    "Silver",
                    "Zinc",
                    "Copper",
                    "Gold"
                ...
                [
                    "The World's Largest desert is ____________?" ,
                    "Thar",
                    "Kalahari",
                    "Sahara",
                    "Sonoran"
...
def medium():
    ...
    mediumQ = [
                ...
                [
                    "The first chairman of the Atomic Energy Commission was _______________________?",
                    "Dr.C.V.Raman",
                    "Dr.H.J.Bhabha",
                ...
                [
                    "D.D.T was invented by ________",
                    "Mosley",
                    "Rudeolf",
                    "Karl Benz",
                    "Dalton"
                ...
                [
                    "Fathometer is used to measure ___________",
                    "Earthquakes",
                    "Rainfall",
                    "Ocean depth",
                    "Sound intensity"
...
def start():
    ...
    img = PhotoImage(file=r"C:\Users\Karishma\Documents\Karishma Projects\MCQ Quiz Application\Quiz-App\images\back.png")
